...
const SiteLayout = ({ children }) => (
  <div className='bg-egg-shell antialiased'>
    <header className='flex flex-wrap justify-between md:items-center md:space-x-4 bg-deep-champaign py-6 px-6 relative'>
      ...
      <nav className='absolute md:relative top-16 left-0 md:top-0 z-20 flex flex-col md:flex-row md:space-x-6 font-semibold w-full md:w-auto bg-deep-champaign shadow-md rounded-lg md:rounded-none md:shadow-none md:bg-transparent p-6 pt-0 md:p-1 align-center'>
        <Link href='/'>
    ...
    <main className='bg-egg-shell h-screen max-h-full'>{children}</main>
  </div>
)
