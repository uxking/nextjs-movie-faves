...
export default function LoginWelcome() {
  return (
    <div className='flex flex-col sm:flex-row justify-around items-center'>
      <div className='py-8 sm:py-32 sm:border-r border-gray-200'>
        To continue, please login to Movie Favorites.
      </div>
      <div className='py-8 sm:py-32'>thei</div>
      {/* <div>
        <div>Hi</div>
        <div className='border-t border-gray-200 md:border-t-0 flex flex-col items-center md:items-start py-4 space-y-4'>
        ...
        <div className='border-t border-gray-200 md:border-t-0 flex flex-col text-center md:items-start py-4'>
          <h3 className='text-xs'>By continuing, you agree to Hi&apos;s</h3>
